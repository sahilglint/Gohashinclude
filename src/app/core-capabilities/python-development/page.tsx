...
const cardsData: Card[] = [
  {
    title: "Retail",
    icon: <FaStore className="text-3xl sm:text-4xl text-[#0271B1]" />,
    desc: "Retailers use Python to design online stores, stock control, understand customers’ habits, and make shopping more engaging and appealing, which increases market demand for products.",
  },
  {
    title: "Education",
    icon: <FaGraduationCap className="text-3xl sm:text-4xl text-[#0271B1]" />,
    desc: "Python has become favorable for developing learning applications such as online classes, learning management systems, and interactive learning tools that enhance contemporary, convenient, and effective learning.",
  },
  {
    title: "Healthcare",
    icon: <FaHeartbeat className="text-3xl sm:text-4xl text-[#0271B1]" />,
    desc: "In the healthcare sector, we have developed Python applications that helped in the extraction and analysis of medical data, patient database systems, artificial intelligence-based diagnostics, and enhanced patient care and organizational management",
  },
  {
    title: "Finance",
    icon: <FaChartLine className="text-3xl sm:text-4xl text-[#0271B1]" />,
    desc: "In the finance industry, Python is used for developing financial software including software trading platforms, risk assessment systems, as well as predictive analytics are used in order to improve overall decision-making as well as guarantee secure and efficient operations.",
  },
  {
    title: "Entertainment",
    icon: <FaFilm  className="text-3xl sm:text-4xl text-[#0271B1]" />,
    desc: "Python drives entertainment applications such as games, streaming platforms, and content management systems to deliver smooth end-user experiences and engaging deliverables.",
  },
  {
    title: "Travel & Transportation",
    icon: <FaPlaneDeparture className="text-3xl sm:text-4xl text-[#0271B1]" />,
...
const services = [
  {
    ...
    desc: "Our Python developers help you design innovative web applications based on the latest technologies and frameworks like Django and Flask along with optimizing your application for business-critical performance, helping to improve security...",
    icon: <FaLaptopCode className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "API Development",
    desc: "We’ve extensive experience in designing well-constructed and highly available APIs that enable different applications to communicate and work together through integrated services, thus improving functionality and overall experience.",
    icon: <FaProjectDiagram className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "Data Analytics and Visualization",
    desc: "As a top Python Development Company, we conduct detailed data analysis and visualizations, with the power of Python in libraries such as Pandas, NumPy, and Matplotlib to turn the raw data into useful information.",
    icon: <FaChartPie className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "Python QA & Testing Services",
    desc: "Throughout our Python development services, we assure you of the superior quality of your Python apps. We assign our certified Q/A on your projects who work on demand to make your apps run smoothly across all browsers & screens.",
    icon: <FaBug className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "AI and Machine Learning Solutions",
    desc: "Introduce complex, slick systems uniformly employing Python’s rich set of machine learning frameworks such as TensorFlow and scikit-learn, for the generation of predictive scenarios necessary for automating processes.",
    icon: <FaBrain className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "Automation and Scripting",
    desc: "Our team is capable enough to solve various business processes such as the creation of simple reports and data analysis with the help of Python scripts to enhance speed and minimize expenses.",
    icon: <FaCogs  className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "Migration to Python",
    desc: "Our Python developers help you port your legacy system to Python or extend your systems with Python scripts to add more capabilities and operations without using up resources.",
    icon: <FaExchangeAlt className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "Python IoT Solutions",
    desc: "Our certified Python developers have designed adaptable IoT applications to manage and control intelligent devices, gather data, and perform functions wirelessly for diverse practical uses.",
    icon: <FaMicrochip className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "Cloud Integration & Deployment", 
    desc: "We help businesses integrate their Python applications with cloud platforms like AWS, Azure, or Google Cloud, ensuring smooth deployment, scalability, and cost efficiency for your digital products.",
    icon: <FaCloud className="text-4xl sm:text-5xl text-[#2071B1]" />, 
...
export default function AI() {
  ...
  const features = [
    {
      title: "Most Popular Language for Beginners",
      desc: "Python is the most preferred language for people learning to code, chosen by 49% of new developers in 2023​",
    },
    {
      title: "High Demand Among Professional Developers",
      desc: "Python is ranked as the third most commonly used programming language, overtaking SQL in 2023. Its usage has grown significantly among professional developers",
    },
    {
      title: "Versatile Application",
      desc: "Python's versatility is showcased by its use across various domains, including web development, data analysis, machine learning, and AI. This widespread application is a key factor in its continued popularity",
    },
  ];
          ...
          <div className="relative max-w-7xl mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center z-10">
            ...
            >
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight">
                Python <span className="text-[#0271B1]">Development</span>
              </h1>
              <p className="text-gray-600 text-sm sm:text-base md:text-lg mt-3 max-w-xl mx-auto md:mx-0">
                ...
                , As a trusted Python Development Company, we help our clients
                craft innovative applications with the most powerful, versatile,
                and flexible frameworks such as Flask, Web2py, and Django. Our
                result-oriented approach and years of experience help you build
                next-gen digital products to gain a competitive edge.
              </p>
              <div className="pt-2">
                <a href="/contact">
                  <motion.button
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
            <div className="text-center md:text-left">
              <h2
                ...
                data-aos="fade-up"
              >
                Python Solution For Industries
              </h2>
              <p
                className="text-gray-600 mb-6 text-sm sm:text-base"
                data-aos="zoom-in"
              >
                Known as one of the best Python web development companies, our
                Python app developers have garnered a decade-long industry-wide
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div>
              <h2
                ...
                data-aos="fade-right"
              >
                Why Choose GOHASHINCLUDE for Python Development?
              </h2>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12 ">
            ...
            <div className="mt-6 md:mt-0 text-left" data-aos="fade-up">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900">
                Benefits of Python Development With Us
              </h2>
              <p className="mt-2 mb-10 lg:mb-2 text-gray-600 text-sm sm:text-base">
                We are the trusted choice for outsourcing Python development
                services. From developing AI/ML projects to Python-driven
                desktop or web applications, our developers are here to help
                you. Explore some of the powerful benefits of Python web app
                development below - :
              </p>
            </div>
              ...
              <div className="space-y-10">
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Python's simple syntax and vast libraries enable faster
                      development, allowing quicker project completion and
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Offering a wide range of applications, from web and mobile
                      development to data science, machine learning, and
                      automation, ensuring your Python solutions meet diverse
                      business needs.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Delivering efficient and scalable Python applications that
                      can handle high workloads and traffic, making them ideal
              ...
              <div className="flex flex-col justify-center space-y-10">
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Leveraging Python’s vast and active developer community,
                      providing access to the latest innovations, tools, and
                      frameworks, ensuring cutting-edge solutions.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Seamless integration with a variety of platforms and
                      technologies, including cloud services, databases, and
                      third-party APIs, to create robust, interconnected
                      systems.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Python’s open-source nature and ability to streamline
                      development processes help reduce overall costs while
                      ensuring high-quality and sustainable results.
                    </p>
                  </div>
                </div>
              </div>
