...
const services = [
  {
    ...
    desc: "At Gohash, our team of expert web developers offers a wide range of Custom Web Development Services from complex enterprise solutions, E-commerce, and ERP to single web apps tailored to your business needs.",
    icon: <FaRobot className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "Web Portal Development",
    desc: "Our web portal developers help you develop feature-rich, easy-to-use, and highly responsive web portals to create reliable and robust web solutions. We help our clients manage workflows with web portal development.",
    icon: <FaBrain className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "Front-End Design & Development",
    desc: "Providing the visitor with a long-lasting impression of your website’s front-end; set up designs that are easy on the eye, as well as easy on the ‘loader’. Our developers work with JavaScript, HTML, CSS, Bootstrap, React, and Vue and make...",
    icon: <FaLanguage className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "Content Management System",
    desc: "As a top-rated Web Development Company, we build custom CMS systems using phpMyAdmin, Visual Studio Code, PHPStorm, and Postman to create, store, and publish digital content.",
    icon: <FaEye className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "Back-End Web Development",
    desc: "Provide your website with reliable back-end solutions. Our focus is on Python, PHP, Java, and Ruby, where we build highly available and balanced systems and unexpected features like administration of data storage, as well as API.",
    icon: <FaCogs className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "Ecommerce Development",
    desc: "We help you create user-friendly storefronts to deliver a delightful shopping experience. Our engineers look after integrating chatbots, payment processing systems, checkout systems, and overall online stores using JavaScript, Python, and Ruby on Rails to reach global audiences....",
    icon: <FaChartBar className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "API Development and Integration",
    desc: "Enrich business apps by integrating them with professional API creation. Our team utilizes API integration through the framework of Express, Django, and ASP. NET has been examined for dependability and productivity with high scores.",
    icon: <FaProjectDiagram className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "Web Support & Maintenance",
    desc: "Gohash is a Web Development Services Company that works closely with you and helps you with overall deployment. Our QA team looks after the bugs, resolves the glitches, and keeps you posted with routine updates and maintenance.",
  ...
  const features = [
    {
      ...
      desc: "By 2024, 50% of all searches across the internet will be voice-based. Source: Campaign",
    },
    {
      title: "Progressive Web Apps (PWAs) Adoption",
      desc: "PWAs are capable of boosting conversions by up to 52%. Source: Think with Google",
    },
    {
      title: "Website Accessibility Impact",
      desc: "Website Accessibility Impact 71% of people with disabilities will leave a website that is not accessible. Source: WebAIM",
    },
  ];
          ...
          <div className="relative max-w-7xl mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center z-10">
            ...
            >
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight">
                Great Web Designs for{" "}
                <span className="text-[#0271B1]">Your Business</span>
              </h1>
              <p className="text-gray-600 text-sm sm:text-base md:text-lg mt-3 max-w-xl mx-auto md:mx-0">
                ...
                Looking for a trusted website development company for your
                business? Try Gohash now! Our expert team of web developers
                helps clients in creating client-focused, customer-centric
                websites and highly customized & fully integrated web
                development solutions at a competitive cost. Call us now if
                you’re looking for website creation services.
              </p>
              <div className="pt-2">
                <a href="/contact">
                  <motion.button
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
            <div className="text-center md:text-left">
              <h2
                ...
                data-aos="fade-up"
              >
                Web Solution For Industries
              </h2>
              <p
                className="text-gray-600 mb-6 text-sm sm:text-base"
                data-aos="zoom-in"
              >
                Known as one of the Web Development services providing
                companies, our battle-tested web developers have garnered a
                decade-long industry-wide experience on niche-based project
                requirements leveraging the latest technologies.
              </p>
              <button
                data-aos="zoom-in"
                onClick={() => paginate(1)}
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div>
              <h2
                ...
                data-aos="fade-right"
              >
                Why Choose GOHASHINCLUDE for Web Development?
              </h2>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12 ">
            ...
            <div className="mt-6 md:mt-0 text-left" data-aos="fade-up">
              ...
              <p className="mt-2 mb-10 lg:mb-2 text-gray-600 text-sm sm:text-base">
                We are a well-known website development company that has
                programming expertise and industry-specific experience knowledge
                for developing responsive and scalable websites tailored to
                diverse business needs. Explore the benefits of our professional
              ...
              <div className="space-y-10">
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Delivering websites tailored to specific business needs,
                      ensuring unique functionality, branding, and user
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Ensuring websites are optimized for all devices, offering
                      a seamless experience across desktops, tablets, and
                      smartphones, enhancing user engagement and accessibility.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Building websites with clean code and best SEO practices,
                      helping improve visibility on search engines and driving
                      organic traffic.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex flex-col justify-center space-y-10">
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      ...
                      ensuring a smooth user experience that reduces bounce
                      rates and increases conversions.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Implementing advanced security measures, such as SSL
                      encryption, firewalls, and regular updates, to protect
                      websites from cyber threats and ensure compliance with
                      industry standards.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      ...
                      monitoring to ensure your website stays functional,
                      secure, and up-to-date as your business grows.
                    </p>
                  </div>
                </div>
              </div>
