...
import { CheckCircle, Cpu, Zap, Bot, Database, BrainCog } from "lucide-react";
import {
  FaMoneyBillWave,
  FaBusAlt,
  FaGraduationCap,
...
const cardsData: Card[] = [
  {
    ...
    desc: "We’ve successfully served the EdTech industry vertical by developing mobile solutions to deliver courses, lectures, and educational materials & conduct quizzes and discussions.",
  },
  {
    title: "AI in Banking",
    icon: <FaUniversity className="text-3xl sm:text-4xl text-[#0271B1]" />,
  ...
  },
  {
    ...
    desc: "We’ve developed AI solutions & chatbots that enable healthcare providers to collect & analyze voluminous medical data and identify patterns & ailment prognoses for smart treatment planning & preventive care.",
  },
  {
    title: "AI in solutions",
  ...
  {
    title: "AI in Retail",
    icon: <FaShoppingBag className="text-3xl sm:text-4xl text-[#0271B1]" />,
    desc: "We’ve developed mobile applications in the retail sector to improve customer interaction by providing a hassle-free shopping experience with easy navigation and secure payments.",
  },
  {
    title: "AI in Travel & Transportation",
    icon: <FaBusAlt className="text-3xl sm:text-4xl text-[#0271B1]" />,
...
const services = [
  {
    ...
    desc: "Robotic Process Automation (RPA) defines new way of managing business processes by using technologies and automating many time-consuming activities. Thus, RPA refers to the employment of software automation tools called ‘bots’",
    icon: <BsRobot className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "Machine Learning (ML)",
    desc: "Our machine learning development services build intelligent models that predict trends, decipher complex data, identify trends & proactively detect frauds to safeguard your business from potential threats.",
    icon: <BrainCog className="text-4xl sm:text-5xl w-10 h-10 text-[#2071B1]" />,
  },
  {
    title: "Chatbots",
    desc: "Build tailor-made intelligent chatbots that improve customer interaction, deliver personalized experience & maximize digital engagement through smart chatbot integration.",
    icon: <SiChatbot className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "AI Agent/ Co-Pilot",
    desc: "We develop intelligent AI agents & copilots using premium tools leveraging the capabilities of LLMs like Gemini & GPT-4o to enhance decision-making, optimize workflows & automate repetitive tasks.",
    icon: <RiCopilotLine className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "Computer Vision",
    desc: "Our AI software development services create advanced algorithms for analyzing & interpreting visual data for image recognition, video analysis, and object detection.",
    icon: <Zap className="text-4xl sm:text-5xl w-10 h-10 text-[#2071B1]" />,
  },
  {
    title: "Generative AI",
    desc: "As one of the top-rated Generative AI Development Companies, we’ve extensive years of experience in developing Generative AI solutions with intelligent capabilities like GPT-3, GPT-3.5, GPT-4, Midjourney & DALL-E to help",
    icon: <Zap className="text-4xl sm:text-5xl w-10 h-10 text-[#2071B1]" />,
  },
  {
    title: "NLP (Natural Language Processing)",
    desc: "Our experts leverage NLP to build smart enterprise applications that extract valuable insights, automate content categorization & enhance customer interactions through sentiment analysis.",
    icon: <Bot className="text-4xl sm:text-5xl w-10 h-13 text-[#2071B1]" />,
  },
  {
    title: "AI -as-a-Service (AIaaS)",
    desc: "We offer AIaaS that empowers your business with advanced data analytics, predictive analysis, and customizable AI models without making significant investments in expensive hardware.",
    icon: <Database className="text-4xl sm:text-5xl w-10 h-10 text-[#2071B1]" />,
  },
  {
    title: "Custom AI Solutions",
    desc: "Develop tailored AI-powered applications to solve your unique business challenges.Align AI initiatives with business goals through expert consulting and roadmap creation.",
    icon: <Cpu className="text-4xl sm:text-5xl w-10 h-10 text-[#2071B1]" />,
  },
  //{
  ...
  const features = [
    {
      ...
      desc: "66% of organizations say that AI is critical for their business success, particularly in enhancing customer experience through personalized interactions and predictive analytics. (Source: Salesforce)",
    },
    {
      title: "AI in Decision-Making",
      desc: "73% of executives believe that AI has the potential to fundamentally change their industry, with 51% already using AI to support decision-making processes. (Source: PwC)",
    },
    {
      title: "AI and Automation",
      desc: "By 2024, AI automation is expected to drive a 20% reduction in business operations costs across various industries, mainly through improved efficiency and reduced manual efforts. (Source: Gartner)",
    },
  ];
          ...
          <div className="relative max-w-7xl mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center z-10">
            ...
            >
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight">
                ...
                <span className="text-[#0271B1]">Services</span>
              </h1>
              <p className="text-gray-600 text-sm sm:text-base md:text-lg mt-3 max-w-xl mx-auto md:mx-0">
                ...
                Transform your business with our artificial intelligence
                software development services. Leverage our state-of-the-art
                Generative AI Development solutions to automate your repetitive
                processes & strengthen your business intelligence for making
                informed decisions.
              </p>
              <div className="pt-2">
                <a href="/contact">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
            <div className="text-center md:text-left">
              <h2
                ...
                data-aos="fade-up"
              >
                AI Solution For Industries
              </h2>
              <p
                className="text-gray-600 mb-6 text-sm sm:text-base"
                data-aos="zoom-in"
              >
                Known as one of the best AI software development companies, our
                AI app developers have garnered a decade-long industry-wide
                experience on niche-based project requirements leveraging the
                latest technologies. From hotel apps to e-commerce shopping apps
                and chatbots, we can successfully address any specific pain
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div>
              <h2
                ...
                data-aos="fade-right"
              >
                Why Choose GOHASHINCLUDE for AI Development?
              </h2>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12 ">
            ...
            <div className="mt-6 md:mt-0 text-left" data-aos="fade-up">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900">
                Benefits of AI Development With Us
              </h2>
              <p className="mt-2 mb-10 lg:mb-2 text-gray-600 text-sm sm:text-base">
                From offering custom-driven AI solutions to data-driven
                decision-making, our AI engineers help you optimize workflow and
                automate routine tasks tailored to your business needs. Explore
                how Gohash can help you transform your business operations.
              </p>
            </div>
              ...
              <div className="space-y-10">
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Automate routine tasks, minimize operation costs &
                      streamline business processes through intelligent
                      decision-making
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Offers personalized customer experience by identifying
                      data patterns, trends, and data insights, improving
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Delivers AI-led scalable solutions to propel your business
                      & evolve with modern market demands.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col justify-center space-y-10">
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Acts as a driving force in bringing rapid innovation by
                      leveraging advanced technologies like NLP & ML.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      AI algorithms can analyze vast amounts of data to uncover
                      the preferences, choices and patterns and that humans may
                      overlook while making informed business decisions
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Enabling businesses to stay ahead of the competition by
                      leveraging AI innovations, improving customer experience,
