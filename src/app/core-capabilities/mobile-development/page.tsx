...
const cardsData: Card[] = [
  ...
  },
  {
    ...
    desc: "We’ve developed mobile apps that enable healthcare providers to allow patients to book appointments conveniently, track health metrics & schedule reminders for checkups.",
  },
  {
    title: "Banking",
  ...
  {
    title: "Solutions",
    icon: <FaHotel className="text-3xl sm:text-4xl text-[#0271B1]" />,
...
const services = [
  {
    ...
    desc: "We have you develop unique, industry-platform-specific mobile applications using Xcode, IDEs, and Android Studio to deliver superior user experience on different platforms.",
    icon: <FaMobileAlt className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "Wearables and Embedded Software",
    desc: "Our expert programmers help you build a unique & custom wearable device application for your business that runs on the most popular wearable devices.",
    icon: <FaWatchmanMonitoring className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "Cross-Platform App Development",
    desc: "Utilizing the power of Flutter, React Native, and Xamarin, we help you develop applications for multiple platforms while sharing the unified code base.",
    icon: <FaClone className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "Flutter App Development",
    desc: "Our Flutter app development services help you create stunning UIs and build scalable and highly functional mobile applications for iOS and Android.",
    icon: <FaLeaf className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "Progressive Web App Development",
    desc: "With PWAs, we deliver modern native-like capabilities that function for anyone, anywhere, on any device with a single codebase.",
    icon: <FaBolt className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "MVP App Development",
    desc: "Want to build MVP for your business? Gohash works closely with you and helps validate your business idea ensuring faster time to market.",
    icon: <FaRocket className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "iOS App Development",
    desc: "Our iOS app developers help you develop robust mobile applications using tools like Interface Builder and Xcode to connect with enterprise corporate clients & streamline development.",
    icon: <FaApple className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "Mobile App Consulting",
    desc: "Our team follows a comprehensive process from discovery to planning, designing, development, and deployment and offers end-to-end consultation services to ensure optimal business growth.",
    icon: <FaLightbulb className="text-4xl sm:text-5xl text-[#2071B1]" />,
  },
  {
    title: "App Maintenance & Support",
    desc: "Continuous monitoring, bug fixes, and upgrades to keep your app future-ready.",
  ...
  const features = [
    {
      ...
      desc: "Fact: The integration of AI and machine learning in mobile apps is on the rise, with 86% of companies planning to invest more in AI capabilities for their mobile apps in 2024. Source: Gartner. (2024). AI in Mobile Applications.",
    },
    {
      title: "User Engagement",
      desc: "Fact: Users spent an average of 4.2 hours per day on mobile apps in 2023, an increase of 30% compared to 2019. Source: eMarketer. (2023). Average Daily Time Spent on Mobile Apps.",
    },
    {
      title: "Augmented Reality (AR) and Virtual Reality (VR)",
      desc: "Fact: The market for AR and VR mobile apps is expected to grow to $72.8 billion by 2024, driven by innovations in gaming, education, and healthcare applications. Source: Statista. (2024). AR and VR Market Growth.",
    },
  ];
          ...
          <div className="relative max-w-7xl mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center z-10">
            ...
            >
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight">
                Mobile app <span className="text-[#0271B1]">Development</span>
              </h1>
              <p className="text-gray-600 text-sm sm:text-base md:text-lg mt-3 max-w-xl mx-auto md:mx-0">
                ...
                As a trusted mobile app development company, we specialize in
                delivering top-notch mobile app services utilizing the next-gen
                technologies and latest tech stacks to convert your business
                ideas into dynamic applications. Our team is specialized in
                developing Android, iOS, & cross-platform development that
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
            <div className="text-center md:text-left">
              <h2
                ...
                data-aos="fade-up"
              >
                Mobile App Solution For Industries
              </h2>
              <p
                className="text-gray-600 mb-6 text-sm sm:text-base"
                data-aos="zoom-in"
              >
                Known as one of the best mobile application development
                companies, our mobile app developers have garnered a decade-long
                industry-wide experience on niche-based project requirements
                leveraging the latest technologies. From hotel apps to
                e-commerce & shopping apps, we can successfully address any
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div>
              <h2
                ...
                data-aos="fade-right"
              >
                Why Choose GOHASHINCLUDE for Mobile App Development?
              </h2>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12 ">
            ...
            <div className="mt-6 md:mt-0 text-left" data-aos="fade-up">
              ...
              <p className="mt-2 mb-10 lg:mb-2 text-gray-600 text-sm sm:text-base">
                From offering custom-driven mobile applications to helping you
                with overall consultation and support, we’re helping to benefit
                your business. Some of the benefits of having a mobile app are-:
              </p>
            </div>
              ...
              <div className="space-y-10">
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Our expert app developers understand your target audience
                      and build a scalable mobile application that helps you
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      We develop mobile apps that are much more accessible to
                      keep your audiences connected and available 24*7 to meet
                      the requirements.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      We offer custom-built mobile applications that can be
                      tailored exactly to your customer’s preferences.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col justify-center space-y-10">
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Building mobile applications is a good way to track
                      customer loyalty programs that encourage repeat orders as
                      well.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Mobile apps allow businesses to learn more about their
                      shoppers and deliver a hyper-personalized shopping
                      experience by making shopping payments, and everything
                      accessible, thus boosting profits.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Implementing strong security measures like data
                      encryption, user authentication, and compliance with
                      industry standards to protect user data and ensure
                      privacy.
                    </p>
                  </div>
                </div>
