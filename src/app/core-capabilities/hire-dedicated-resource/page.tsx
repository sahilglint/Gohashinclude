...
export default function AI() {
  ...
  const features = [
    {
      title: "Growth in Adoption",
      desc: "According to Forrester Research, the low-code development platform market is expected to grow at a compound annual growth rate (CAGR) of 40% to reach $21.2 billion by 2022. (Source: Forrester Research).",
    },
    {
      title: "Productivity Gains",
      desc: "A study by Mendix found that organizations using low-code platforms reported an average productivity increase of 65%, with application development time reduced by 70%. (Source: Mendix).",
    },
    {
      title: "Business Impact",
      desc: "According to Gartner, by 2024, low-code application development will account for more than 65% of application development activity. (Source: Gartner).",
    },
  ];
          ...
          <div className="relative max-w-7xl mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center z-10">
            ...
            >
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight">
                Hire Dedicated <span className="text-[#0271B1]">Resources</span>
              </h1>
              <p className="text-gray-600 text-sm sm:text-base md:text-lg mt-3 max-w-xl mx-auto md:mx-0">
                ...
                As a prominent web solutions company, we offer the best
                engagement models tailored to meet diverse business needs. We
                have industry-specific professionals who work closely with you
                and leave no stone unturned in delivering nothing but superior
                results with guaranteed security.
              </p>
              <div className="pt-2">
                <a href="/contact">
                  <motion.button
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
            <div className="text-center md:text-left">
              ...
              <p
                ...
                data-aos="zoom-in"
              >
                Known as one of the Best Low-Code Development Platforms, our
                low-code app developers have garnered a decade-long
              ...
              <div className="space-y-10">
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Low-code platforms accelerate the development process by
                      enabling quicker prototyping, testing, and deployment,
                      reducing time-to-market for applications.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Intuitive drag-and-drop interfaces and visual development
                      environments allow non-technical users and citizen
                      developers to contribute to application development.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Low-code platforms enable better collaboration between
                      developers and business stakeholders, fostering clear
                      communication and aligning goals through shared visibility
              ...
              <div className="flex flex-col justify-center space-y-10">
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Lower development costs by minimizing the need for
                      extensive coding expertise and reducing reliance on large
                      development teams, making it a cost-efficient solution for
                      businesses.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Rapid iterations and updates allow businesses to respond
                      quickly to market changes, evolving business needs, or
                      customer feedback without extensive redevelopment.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-1 text-sm md:text-base leading-relaxed">
                      Low-code solutions can easily integrate with existing
                      systems and scale as your business grows, ensuring
                      flexibility and longevity for the applications you build.
                    </p>
                  </div>
                </div>
              </div>
